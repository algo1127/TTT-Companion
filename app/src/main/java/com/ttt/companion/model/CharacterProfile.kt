 ...
 * For Phase 1 we hardcode a default to test with.
 */
data class CharacterProfile(
    val id: String,
    val name: String,
    val systemPrompt: String,
    val modelPath: String,   // path to model folder on device
    val voicePath: String = "",  // Phase 2
    val vrmPath: String = ""     // Phase 4
)

// Build at runtime so modelPath uses the real filesDir
